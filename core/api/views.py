...
from .serializers import (
    AddressSerializer, ItemSerializer, OrderSerializer, ItemDetailSerializer,
    PaymentSerializer
)
...
class AddToCartView(APIView):
    def post(self, request, *args, **kwargs):
        ...
        minimum_varaition_count = Variation.objects.filter(item=item).count()
        if len(variations) < minimum_varaition_count:
